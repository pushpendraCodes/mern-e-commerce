      ...
      <Disclosure as="nav" className="">
        {({ open }) => (
          <>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="hidden lg:block">
                    ...
                    >
                      <Link style={{marginRight:"30px"}} className="text-3xl mb-3 text-white " to="/">
                        Apna Cart
                      </Link>
                      {user?.role === "user" && (
                        <>
                          {navigation.map((item) => {
                            return (
                              <Link
                                ...
                                key={item.name}
                                to={item.href}
                                className="text-gray-500 hover:text-white text-sm ml-4 cursor-pointer "
                              >
                                {item.name}
                              </Link>
                            );
                ...
                <div className="hidden lg:block">
                  <div className="ml-4 flex   items-center md:ml-6">
                    <div style={{ marginRight: "15PX" }} className="relative ">
                      <Link to="/cart">
                        <img
            ...
            <Disclosure.Panel style={{ padding: "3px" }} className="md:hidden ">
