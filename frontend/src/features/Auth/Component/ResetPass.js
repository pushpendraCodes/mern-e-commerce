...
export default function ResetPassword() {
  ...
  const error = useSelector(errore);
        ...
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            <img
              ...
              src="https://cdn.shopify.com/s/files/1/0566/0839/1368/files/overlay_small_logo_b26282df-c7f1-44c3-9299-52b939f876ea.png?v=1650558069"
              alt="Your Company"
            />
